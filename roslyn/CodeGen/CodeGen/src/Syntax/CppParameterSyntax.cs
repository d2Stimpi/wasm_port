...
namespace CodeGen.Syntax
{
    internal sealed class CppParameterSyntax : CppSyntaxNode
    {
        ...
        public CppParameterSyntax(CppTypeSyntax type, string name, List<string> modifiers, string defaultValue)
        {
            _type = type;
            _name = name;
    ...
    internal class CppArgumentSyntaxList : List<CppParameterSyntax>
    {
